    ...
    <div className="mb-6">
      <div className="mb-3 flex items-center gap-3">
        <button
          ...
          className="flex items-center gap-2 text-sm font-medium text-[#E8E8F0] hover:text-primary"
        >
        ...
        {dismissedCount > 0 && !collapsed && (
          <button
            ...
            className="flex items-center gap-1 text-[10px] text-muted-foreground hover:text-[#E8E8F0]"
          >
