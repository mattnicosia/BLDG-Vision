        ...
        {[
          {
            ...
            sub: `${metrics.pipelineCount} active deals`,
            valueColor: '#06B6D4',
          },
          {
            to: '/pipeline',
            icon: TrendingUp,
            label: 'Weighted',
            value: `$${(metrics.weightedValue / 1000000).toFixed(1)}M`,
          ...
          >
            ...
            <p
              className="metric-number mt-2 text-[28px] leading-none"
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <div
                        ...
                        style={{ backgroundColor: pulseColor, boxShadow: `0 0 6px ${pulseColor}` }}
                      />
                      <div>
          ...
          {recentSignals.length === 0 ? (
            ...
            <div className="flex flex-col gap-1.5">
              {recentSignals.map((signal) => {
                const dotColor =
                  signal.priority === 'high' ? '#EF4444' : signal.priority === 'medium' ? '#F59E0B' : '#06B6D4'
                return (
                  <div
                    key={signal.id}
