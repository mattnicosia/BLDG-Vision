    ...
    <div className="mx-auto max-w-5xl">
      ...
      {tab === 'fetch' && (
        <div className="flex flex-col gap-4">
          {/* Search controls */}
          <div className="flex flex-col gap-3 rounded-xl border border-border bg-[#1C1C1C] p-4" style={{ borderWidth: '0.5px' }}>
          ...
          {fetched && previews.length > 0 && (
            <>
              {/* Action bar */}
              <div className="flex items-center justify-between rounded-lg bg-[#141414] px-4 py-2">
